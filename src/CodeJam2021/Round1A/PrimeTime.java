...
public class PrimeTime {
    ...
    public static void main(String[] args) {
        ...
        for (int testCase = 0; testCase < nTestCases; testCase++) {
            ...
            long product = 1;
            long max = findMax(card, sum, product,0,0, m, indexSumLimit, sum);
    ...
    private static long findMax(long[][] card, long sum,long product, int index, long sumOfProdGroup, int m, long indexSumLimit, long maxSum) {
        if (sum == product)
            return sum;
